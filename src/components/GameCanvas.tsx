...
const GameCanvas: React.FC<GameCanvasProps> = ({ backgroundSpeed = .75, onNavigate, showUI = true }) => {
  ...
  useEffect(() => {
    ...
    // =============================================
    // ENEMY TYPE A - AGORA EM ARQUIVO SEPARADO
    // =============================================
    // A classe EnemyTypeA foi movida para src/game/entities/EnemyTypeA.ts
    // e agora herda corretamente de AbstractEntity com todas as funcionalidades otimizadas.

    // =============================================
    // ENEMY TYPE B - AGORA EM ARQUIVO SEPARADO
    // =============================================
    // A classe EnemyTypeB foi movida para src/game/entities/EnemyTypeB.ts
    // e agora herda corretamente de AbstractEntity com todas as funcionalidades otimizadas.

    // =============================================
    // ENEMY TYPE C - AGORA EM ARQUIVO SEPARADO
    // =============================================
    // A classe EnemyTypeC foi movida para src/game/entities/EnemyTypeC.ts
    // e agora herda corretamente de AbstractEntity com todas as funcionalidades otimizadas.
