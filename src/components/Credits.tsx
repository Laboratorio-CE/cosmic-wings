...
const Credits: React.FC<CreditsProps> = ({ onNavigateToMenu }) => {
  ...
  return (
    <div className="flex justify-center items-center h-screen min-h-screen p-0 sm:p-4">
      <div className="w-full h-full sm:w-[800px] sm:h-[600px] bg-gradient-to-br from-black/80 to-blue-900/90 border-2 border-cyan-400 rounded-2xl text-white font-mono shadow-2xl shadow-cyan-400/20 flex flex-col items-center justify-start px-4 sm:px-8 py-6 overflow-y-auto scrollbar-styled">
        {/* Título */}
